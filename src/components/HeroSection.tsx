...
export function HeroSection({ config, dict, locale = "en" }: HeroSectionProps) {
  ...
  return (
    <section className="relative flex flex-col items-center h-[calc(100vh-5rem)] overflow-hidden">
      ...
      <div className="relative z-10 w-full shrink-0 flex flex-col items-center text-center px-4 pb-2 -mt-56 md:mt-0 animate-fade-in-up opacity-0" style={{ animationFillMode: "forwards" }}>
