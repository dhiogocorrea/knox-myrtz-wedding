    ...
    <section className="relative flex flex-col items-center h-[calc(100vh-5rem)] overflow-hidden">
      ...
      <div className="relative flex-1 w-full flex items-center justify-center min-h-0">
        ...
        <img
          ...
          alt=""
          className="h-full max-h-full object-contain select-none opacity-100 pointer-events-none transform scale-250 translate-y-16 md:scale-100 md:translate-y-15"
          draggable={false}
        />
      ...
      <div className="relative z-10 w-full shrink-0 flex flex-col items-center text-center px-4 pb-2 -mt-16 md:mt-0 animate-fade-in-up opacity-0" style={{ animationFillMode: "forwards" }}>
